...
# A 100-step task can afford a small number of deliberate strategy reviews.
# The domain contract defines the fallback cadence as 20 completed decisions
# when the browser remains on the same page.
